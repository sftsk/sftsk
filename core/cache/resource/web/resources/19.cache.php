<?php  return array (
  ...
  array (
    ...
    'isfolder' => 0,
    'introtext' => '',
    'content' => 'This interface draft for a quiz-game is the result of a 48h Hackathon organized by Bonnier Publications: <a href="http://www.bonnierdevcamp.fi/">http://www.bonnierdevcamp.fi/</a><br>
The graphical style matches the style of the woman\'s magazine Olivia published by Bonnier.<br>
In the short amount of time we were able to implement it on an Android and a Windows Phone Series 7 (demo-)application.',
    'richtext' => 1,
    'template' => 4,
    'menuindex' => 3,
    'searchable' => 1,
    'cacheable' => 1,
    'createdby' => 1,
    'createdon' => 1323773245,
    'editedby' => 1,
    'editedon' => 1323774143,
    'deleted' => 0,
    'deletedon' => 0,
    'deletedby' => 0,
    'publishedon' => 1323773340,
    'publishedby' => 1,
    'menutitle' => '',
    'donthit' => 0,
    'privateweb' => 0,
...
<li><img src="[[++site_url]]assets/_img/ofc/bonnier_screens5.jpg" width="978" height="560" alt="ofc screenshot"></li>
    ...
    array (
      0 => 'tvProjectThumb',
      1 => 'assets/_img/ofc/ofc_thumb.jpg',
      2 => 'default',
      3 => NULL,
      4 => 'image',
    ),
...
<header class="row">
	<div id="title" class="col4">
		...
		<div id="sub_title"><h2>ofc</h2></div>		
...
<ul>
<li><img src="http://maakee.me/assets/_img/ofc/bonnier_screens0.jpg" width="978" height="560" alt="ofc screenshot"></li>
<li><img src="http://maakee.me/assets/_img/ofc/bonnier_screens1.jpg" width="978" height="560" alt="ofc screenshot"></li>
<li><img src="http://maakee.me/assets/_img/ofc/bonnier_screens2.jpg" width="978" height="560" alt="ofc screenshot"></li>
<li><img src="http://maakee.me/assets/_img/ofc/bonnier_screens3.jpg" width="978" height="560" alt="ofc screenshot"></li>
<li><img src="http://maakee.me/assets/_img/ofc/bonnier_screens4.jpg" width="978" height="560" alt="ofc screenshot"></li>
<li><img src="http://maakee.me/assets/_img/ofc/bonnier_screens5.jpg" width="978" height="560" alt="ofc screenshot"></li>
</ul>
</div></div>
<div id="single_project_title">ofc</div>
<div class="textblock col7">
This interface draft for a quiz-game is the result of a 48h Hackathon organized by Bonnier Publications: <a href="http://www.bonnierdevcamp.fi/">http://www.bonnierdevcamp.fi/</a><br>
The graphical style matches the style of the woman\'s magazine Olivia published by Bonnier.<br>
In the short amount of time we were able to implement it on an Android and a Windows Phone Series 7 (demo-)application.
</div>
<hr class=\'col12 last\'>
