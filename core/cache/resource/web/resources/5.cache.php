<?php  return array (
  ...
  array (
    ...
    'pagetitle' => 'Dali Server UI',
    'longtitle' => '',
    'description' => '',
    'alias' => 'dali-server-ui',
    'link_attributes' => '',
    'published' => 1,
    'pub_date' => 0,
    'unpub_date' => 0,
    ...
    'isfolder' => 0,
    'introtext' => '',
    'content' => 'Conceptualisation and elaboration of an interface to control a lighting system.
The interface was designed for a proprietary touch-panel and then ported to work on the iPad.',
    'richtext' => 1,
    'template' => 4,
    'menuindex' => 1,
    'searchable' => 1,
    'cacheable' => 1,
    'createdby' => 1,
    'createdon' => 1310040549,
    'editedby' => 1,
    'editedon' => 1310065969,
    'deleted' => 0,
    'deletedon' => 0,
    'deletedby' => 0,
    'publishedon' => 1310040720,
    'publishedby' => 1,
    'menutitle' => '',
    'donthit' => 0,
    'privateweb' => 0,
...
<li><img src="[[++site_url]]assets/_img/daliserver/dali_6.png" width="978" height="560" alt="Screenshot Dali Server UI"></li>
    ...
    array (
      0 => 'tvProjectThumb',
      1 => 'assets/_img/daliserver/dali_thumb.jpg',
      2 => 'default',
      3 => NULL,
      4 => 'image',
    ),
...
<header class="row">
	<div id="title" class="col4">
		...
		<div id="sub_title"><h2>Dali Server UI</h2></div>		
...
<ul>
<li><img src="http://maakee.me/assets/_img/daliserver/dali_1.png" width="978" height="560" alt="Screenshot Dali Server UI"></li>
<li><img src="http://maakee.me/assets/_img/daliserver/dali_2.png" width="978" height="560" alt="Screenshot Dali Server UI"></li>
<li><img src="http://maakee.me/assets/_img/daliserver/dali_3.png" width="978" height="560" alt="Screenshot Dali Server UI"></li>
<li><img src="http://maakee.me/assets/_img/daliserver/dali_4.png" width="978" height="560" alt="Screenshot Dali Server UI"></li>
<li><img src="http://maakee.me/assets/_img/daliserver/dali_5.png" width="978" height="560" alt="Screenshot Dali Server UI"></li>
<li><img src="http://maakee.me/assets/_img/daliserver/dali_6.png" width="978" height="560" alt="Screenshot Dali Server UI"></li>
</ul>
</div></div>
<div id="single_project_title">Dali Server UI</div>
<div class="textblock col7">
Conceptualisation and elaboration of an interface to control a lighting system.
The interface was designed for a proprietary touch-panel and then ported to work on the iPad.
</div>
<hr class=\'col12 last\'>
